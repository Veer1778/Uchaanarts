...
/**
 * From reactbits.dev — animates text word-by-word or letter-by-letter with a
 * blur/opacity/y sweep once the element scrolls into view. Kept API-identical
 * to the source; only added "use client" and TS-friendly types.
 */
