...
/**
 * From reactbits.dev — a curved, scrollable WebGL gallery.
 * Kept faithful to the source; added "use client" and loose TS types.
 */
...
class Media {
  ...
  program: any; plane: any; title: any; speed = 0;
  scale = 1; padding = 2; width = 0; widthTotal = 0; x = 0;
...
class App {
  ...
  medias: Media[] = []; mediasImages: any[] = [];
  screen: any; viewport: any;
  raf = 0;
  isDown = false; start = 0;
  boundOnResize: any; boundOnWheel: any; boundOnTouchDown: any;
  boundOnTouchMove: any; boundOnTouchUp: any; boundOnKeyDown: any;
  ...
  addEventListeners() {
    ...
    // Scoped to the canvas so the component never hijacks page scroll.
    this.gl.canvas.addEventListener("wheel", this.boundOnWheel, { passive: true });
...
export default function CircularGallery({
  ...
  return <div className="circular-gallery" ref={containerRef} tabIndex={0} />;
}
